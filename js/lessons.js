  ...
  },
{
  title: "9　二次元リスト",
  description:
    "リストの中にリストを入れると、表のように行と列をもつデータを表せます。要素は「リスト名[行][列]」で取り出します。",
  example: `scores=[
    [80,90,70],
    [65,75,85]
]
...
for row in scores:
  ...
  rows: [
    [
      "scores=[[80,90,70],[65,75,85]]",
      "2行3列の二次元リストを作り、変数scoresに代入する",
      "scores←［［80,90,70］,［65,75,85］］"
    ],
    ["", "", ""],
    [
      "print(scores[0][1])",
      "1行目の2列目にある90を表示する。Pythonでは番号を0から数える",
      "scores[0][1]を表示する"
    ],
    ["", "", ""],
    [
      "for row in scores:",
      "scoresから1行ずつ取り出してrowに代入しながら繰り返す",
      "scoresのすべての要素をrowに順番に代入しながら、繰り返す"
    ],
    [
      "    for score in row:",
      "rowから値を1つずつ取り出してscoreに代入しながら繰り返す",
      "　rowのすべての要素をscoreに順番に代入しながら、繰り返す"
    ],
    [
      '        print(score,end=" ")',
      "scoreの値を改行せず、空白を付けて表示する",
      "　　scoreを改行せずに表示する"
    ],
    [
      "    print()",
